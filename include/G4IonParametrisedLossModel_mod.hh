...
#ifndef G4IonParametrisedLossModel_mod_HH
#define G4IonParametrisedLossModel_mod_HH
...
class G4IonParametrisedLossModel_mod : public G4VEmModel {

 public:
   G4IonParametrisedLossModel_mod(const G4ParticleDefinition* particle = 0,
                              const G4String& name = "ParamICRU73_modified");

   virtual ~G4IonParametrisedLossModel_mod();
   ...
   // Function to obtain SRIM stopping power data
    G4PhysicsFreeVector* FillStopVector(G4String filename, G4int atomic_no);    
    void UseSRIMData(bool a)			{useSRIMData = a;}
 protected:
 ...
 private:
   ...
   G4IonParametrisedLossModel_mod & operator=(
                              const G4IonParametrisedLossModel_mod &right);
   G4IonParametrisedLossModel_mod(const G4IonParametrisedLossModel_mod &);
...
#include "G4IonParametrisedLossModel_mod.icc"
