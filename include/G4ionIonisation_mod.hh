...
#ifndef G4ionIonisation_mod_h
#define G4ionIonisation_mod_h 1
...
class G4ionIonisation_mod : public G4VEnergyLossProcess
{
public:

  explicit G4ionIonisation_mod(const G4String& name = "ionIoni");

  virtual ~G4ionIonisation_mod();
...
private:
  ...
  G4ionIonisation_mod & operator=(const G4ionIonisation_mod &right) = delete;
  G4ionIonisation_mod(const G4ionIonisation_mod&) = delete;
...
inline void G4ionIonisation_mod::ActivateStoppingData(G4bool val)
{
  stopDataActive = val;
}
...
inline G4double G4ionIonisation_mod::BetheBlochEnergyThreshold()
{
  return eth;
}
