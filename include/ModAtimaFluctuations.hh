...
//
//
// File name:     ModAtimaFluctuations
//
...
#ifndef ModAtimaFluctuations_h
#define ModAtimaFluctuations_h 1
...
class ModAtimaFluctuations : public G4VEmFluctuationModel
{

public:

  explicit ModAtimaFluctuations(const G4String& nam = "IonFlucAtima");

  virtual ~ModAtimaFluctuations();
...
private:
  ...
  ModAtimaFluctuations & operator=(const  ModAtimaFluctuations &right) = delete;
  ModAtimaFluctuations(const  ModAtimaFluctuations&) = delete;
